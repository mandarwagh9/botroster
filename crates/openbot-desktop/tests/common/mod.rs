//! Shared by the OPENBOT test binaries that drive the live stack.
//!
//! A copy of the harness in `openbot-cli/tests/common`, because test-support
...
/// Stop a `openbot up` and everything it started.
///
...
///
/// On Unix, SIGTERM first: `openbot up` handles it and tears the browser down
